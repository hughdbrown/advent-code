...
def passports(data):
    ...
    for index in indexes:
        yield reduce(set.union, lines[i:index], set(lines[i]))
        i = index + 1
...
def passports2(data):
    ...
    i = 0
    for index in indexes:
        yield reduce(set.intersection, lines[i:index], set(lines[i]))
        i = index + 1

def puzzle1(data):
    return sum(len(passport) for passport in passports(data))

def puzzle2(data):
    return sum(len(passport) for passport in passports2(data))
